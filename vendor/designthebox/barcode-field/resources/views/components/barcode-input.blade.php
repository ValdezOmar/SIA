...
<div xmlns:x-filament="http://www.w3.org/1999/html">
    <div class="grid gap-y-2">
        ...
        <x-filament::input.wrapper class="relative">
            ...
            <button type="button" onclick="openScannerModal()" class="absolute inset-y-0 right-0 flex items-center pr-3 focus:outline-none" aria-label="Escanea el QR o Código de Barras">
    ...
    <x-filament::modal id="barcode-scanner-modal">
        <x-slot name="header">
            <h2 class="text-lg font-semibold">
                Escanea el QR o Código de Barras
            </h2>
        </x-slot>
