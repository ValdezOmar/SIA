        ...
        <div class="table-responsive">
            <table class="table table-borderless table-hover">
              ...
              <tbody>
                  ...
                  <tr>
                    <td width="10px"><a href="{{route('correspondencia.hojaruta.edit', $hojaruta)}}" class="btn btn-outline-primary btn-sm" ><i class="fas fa-arrow-right"></i></a></td>
                    <td width="10px"><button  type="button" class="btn btn-outline-success btn-sm openBtn" data-toggle="modal" data-target="#agregarEmpleado{{ $hojaruta}}" title="Ver la informacion completa de la persona"><i class="fas fa-fw fa-eye"></i></button></td>
                    <td width="10px"><a href="{{route('correspondencia.crearDerivacion', $hojaruta)}}" class="btn btn-outline-warning btn-sm" ><i class="fas fa-fw fa-edit"></i></a></td>
