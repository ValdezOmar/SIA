...
class EventosRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Actions\Action::make('detalle')->label('Ver cambios')->modalSubmitAction(false)->modalCancelActionLabel('Cerrar')
                ->infolist([
        ...
        ])->headerActions([])->bulkActions([])->defaultSort('id', 'desc');
    }
}
