...
use App\Filament\Resources\Ventas\CotizacionResource\Pages\CreateCotizacion;
use App\Filament\Resources\Ventas\CotizacionResource\Pages\EditCotizacion;
...
class CotizacionResource extends Resource
{
    ...
    private static function formatearNumero($valor, $decimales = 2): string
    {
        ...
        // Si es 0 o no tiene decimales, mostrar como entero
