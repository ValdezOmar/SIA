    ...
    protected function getHeaderActions(): array
    {
        ...
        return [
            ...
            Action::make('rechazar')
                ...
                ->color('danger')
                ->visible(fn () => $transferencia->estado === 'en_transito' && (int) $transferencia->receptor_id === (int) auth()->id())
                ->schema([Textarea::make('motivo')->label('Motivo del rechazo')->required()->maxLength(2000)->helperText('Explique la diferencia o incidencia encontrada.')])
            ...
            DeleteAction::make()->visible(fn () => $transferencia->estado === 'borrador'),
        ];
    }
