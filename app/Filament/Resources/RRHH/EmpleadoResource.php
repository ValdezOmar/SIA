            ...
            ->schema([
                        ...
                        Fieldset::make('Direccion y croquis de domicilio')
                            ->schema([
                                TextInput::make('direccion')                            
                                    ...
                                    ->hint('Escriba y sellecione la dirección de residencia personal')
                                    ->hintIcon('heroicon-o-home'),
                                Field::make('ubicacion_gps')
                                    ->label('Dirección completa')
                                    ->hint('Seleccione la ubicación en el mapa')
                ...
                Section::make('Datos Personales Adicionales')
                    ->schema([
                        ...
                        TextInput::make('nua_cua')
                            ->label('NUA/CUA')
                            ->hint('Número de afiliación al seguro social')
                ...
                //->disabled()
                    ->schema([
                        ...
                        TextInput::make('afp')
                            ->label('AFP')
                            ->hint('Nombre de la AFP a la que está afiliado')
