...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('ven_cotizaciones', function (Blueprint $table) {
            ...
            // Identificación, alcance y responsables
            ...
            $table->enum('estado', ['borrador', 'enviada', 'aprobada', 'rechazada', 'convertida', 'expirada'])->default('borrador');
            $table->string('condicion_pago', 100)->nullable();
            $table->char('moneda', 3)->default('BOB');
            $table->decimal('tasa_cambio', 18, 6)->nullable()->default(1);
